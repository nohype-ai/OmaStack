...
The installer asks for your stack folder and runs `omack init`.
That writes `wanted.txt` and `unwanted.txt` in the stack folder.
`~/.config/omastack/config.toml` stores the path to that folder.
